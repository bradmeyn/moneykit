...
export const calculators: Calculator[] = [
	{
		...
		viewBox: '0 0 576 512',
		description: 'Build a portfolio of ETFs, estimating past returns & expected annual cost.',
		iconPath:
	...
	// 	viewBox: '0 0 448 512',
	// 	description: 'Estimate your income tax liability including Medicare & Help Repayments',
	// 	iconPath:
