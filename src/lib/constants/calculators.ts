export const calculatorsByCategory = {
	Savings: [
		...
		},
		{
			...
			description: 'Plan your path to financial independence', // Updated the description to be more accurate
			viewBox: '0 0 448 512',
			iconPath:
	...
	Retirement: [
		{
			...
			viewBox: '0 0 576 512',
			description: 'Estimate your ability to achieve your retirement goals',
			iconPath:
				'M288 0C129 0 0 129 0 288s129 288 288 288s288-129 288-288S447 0 288 0zm0 448c-119 0-216-97-216-216S169 16 288 16s216 97 216 216s-97 216-216 216z'
		}
	]
} as const;
