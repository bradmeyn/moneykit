...
<svelte:head>
	<title>Mortgage Calculator | BudgetKit</title>
	<meta
		name="description"
		content="Calculate your mortgage repayments, total interest, and amortisation schedule for principal & interest, interest only, or variable rate loans."
	/>
</svelte:head>
